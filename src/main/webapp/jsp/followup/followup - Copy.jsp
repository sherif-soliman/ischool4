...
function Check_inputs()
{
	...
	{
		alert("Please, select the target class name or student ...");
		return false;
	}
								...
								<tr>
									...
									<td>
										<h:selectOneMenu id="classYears" value="#{followup.classYears.selectedValue}"
		                                      ...
		                                      <a4j:support  event="onchange" actionListener="#{followup.onClassYearsChange}"  reRender="classNames, students" oncomplete="hide_progress_bar();"/>
									...
									<h:selectOneMenu id="classNames"
		                                      ...
		                                      <a4j:support  event="onchange" actionListener="#{followup.onClassNamesChange}"  reRender="students" oncomplete="hide_progress_bar();" />
                        				</h:selectOneMenu>	
...
<td>
									<h:selectOneMenu id="students"
                                                     value="#{followup.students.selectedValue}"
                                                     style="width:160px;" >                                                     
		                                      
		                                      
		                                      <f:selectItems value="#{followup.students.values}"/>
		                                      <a4j:support  event="onchange" actionListener="#{followup.onStudentsChange}"  reRender="exercises_top_reports , exam_top_reports , homework_top_reports" oncomplete="hide_progress_bar();"/>
							...
							<table cellpadding="0" cellspacing="2px" width="100%">
								...
								<tr>
									...
									<h:dataTable id="followups"
										...
										<h:outputText value=" On #{trows.creationDate} "
														style="color: red;  
										font-family: Verdana, Arial, Sans-Serif; font-size:13px;" />
								...
								<h:outputText value="#{trows.id}" ></h:outputText>
								<h:commandButton image="../../images/static/common/delete.png"
									rendered="#{trows.getUserName().equals(posts.getUserName())}" action="#{followup.deactivateFollowup}"
								style="width:20px"
									alt="Deactivate">
