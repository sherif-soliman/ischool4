...
{
	//alert('try');
	document.getElementById('teachers_colmn').innerHTML = document.getElementById('teachers_colmn').innerHTML;
}
...
<td >
	<h:inputText id="fromDate" value="#{activityReportBean.fromDate}" style="height:14px; width:80px;" disabled="true" onchange="refresh_div();">
...
<td>
	<h:inputText id="toDate" value="#{activityReportBean.toDate}" style="height:14px; width:80px;" disabled="true" onchange="refresh_div();">
					...
					<td id="teachers_colmn">
						...
						<h:selectOneMenu id="teachers" value="#{activityReportBean.teachers.selectedValue}"
		                                      ...
		                                      <a4j:support  event="onchange" actionListener="#{activityReportBean.onTeachersChange}"  reRender="questions, exercises, exams, homeworks" oncomplete="hide_progress_bar();"  />
