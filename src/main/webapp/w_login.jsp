		...
		<h:form >
			...
			<td>
				...
				<table cellpadding="0" cellspacing="0" width="90%" border="0">
					...
					<div style="color: #FFFFFF; background-color:#0066ff; font-family: Verdana, Arial, Sans-Serif; font-size: 15px; width:300px; height: 50px; line-height: 50px; boarder: 1; " align="center">
